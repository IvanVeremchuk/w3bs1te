  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white scroll-snap-container">
      <div className="max-w-6xl mx-auto px-5 md:px-8 lg:px-16">
        ...
        <section id="construction" className="my-12 md:my-14 lg:my-16 scroll-snap-section">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              <div className="text-center">
                <div
                  ...
                  onClick={() => setSelectedImage('/images/IMG_20250220_085702286_HDR.webp')}
                >
                  <img
              ...
              <div className="text-center">
                <div
                  className="relative w-full rounded-xl overflow-hidden shadow-lg cursor-pointer transition-all duration-300 bg-[rgba(30,30,30,0.5)] hover:-translate-y-1 hover:shadow-2xl"
                  style={{ paddingBottom: '75%' }}
                  onClick={() => setSelectedImage('/images/IMG_20250219_103925097_HDR.webp')}
                >
                  <img
              ...
              <div className="text-center">
                <div
                  className="relative w-full rounded-xl overflow-hidden shadow-lg cursor-pointer transition-all duration-300 bg-[rgba(30,30,30,0.5)] hover:-translate-y-1 hover:shadow-2xl"
                  style={{ paddingBottom: '75%' }}
                  onClick={() => setSelectedImage('/images/IMG_20250204_161447576_HDR.webp')}
                >
                  <img
              ...
              <div className="text-center">
                <div
                  className="relative w-full rounded-xl overflow-hidden shadow-lg cursor-pointer transition-all duration-300 bg-[rgba(30,30,30,0.5)] hover:-translate-y-1 hover:shadow-2xl"
                  style={{ paddingBottom: '75%' }}
                  onClick={() => setSelectedImage('/images/IMG_20250131_130444773_HDR.webp')}
                >
                  <img
